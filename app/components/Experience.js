            ...
            >
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 md:gap-8">
                ...
                <div className="flex items-center gap-6 md:gap-10">
                  ...
                  <h3 className="text-lg md:text-xl font-semibold tracking-tight text-neutral-900 dark:text-neutral-100 group-hover:translate-x-1 transition-transform duration-300">
                    {exp.role}
                  </h3>
                </div>

                {/* Right — Organization */}
                <p className="text-sm text-neutral-400 dark:text-neutral-500 md:text-right pl-16 md:pl-0 group-hover:text-neutral-600 dark:group-hover:text-neutral-300 transition-colors">
                  {exp.organization}
                </p>
              </div>
            </motion.div>
